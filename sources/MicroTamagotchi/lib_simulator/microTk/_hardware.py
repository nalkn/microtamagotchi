...
'''
__all__ = ['button_a', 'button_b', 'pin_logo', 'temperature']
...
button_a = _button(1, "a")  # left mouse button
button_b = _button(3, "b")  # right mouse button
pin_logo = _button(None, "logo")  # space
...
_pin.music_pin = pin0 # type: ignore
